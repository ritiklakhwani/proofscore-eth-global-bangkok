  ...
  return (
    <div className={`card p-6 ${isLocked ? "opacity-75" : ""}`}>
      <div className="flex items-center justify-between mb-6">
        ...
        {network.isTestnet && (
          <span className="px-2 py-1 text-xs font-medium rounded-full bg-yellow-500/20 text-yellow-400">Testnet</span>
        )}
      </div>
      ...
      {isLocked ? (
        ...
        <div className="space-y-6">
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            <TokenList tokens={data?.raw?.tokenTransfers || []} explorerUrl={network.explorer} />
            <TransactionList
