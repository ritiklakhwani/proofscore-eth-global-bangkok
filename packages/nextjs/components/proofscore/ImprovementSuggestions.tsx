...
export default function ImprovementSuggestions() {
  const suggestions = [
    ...
    },
    {
      ...
      impact: "+30 points",
      timeframe: "1-2 weeks",
      steps: ["Schedule regular transactions", "Use DeFi protocols consistently", "Maintain active wallet usage"],
    },
    {
      ...
      steps: ["Research potential tokens", "Create a balanced portfolio", "Monitor market conditions"],
    },
  ];
          ...
          <div key={index} className="group relative">
            <div className="p-6 border border-gray-800 rounded-lg bg-gray-900/50 hover:bg-gray-800/50 transition-all duration-200">
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                <div className="flex items-center space-x-2">
                  <span className="text-sm text-gray-400">Timeframe: {suggestion.timeframe}</span>
                </div>
              </div>
