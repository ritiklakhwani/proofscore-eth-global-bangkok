...
import { AlertCircle, CheckCircle, Info, Minus, TrendingDown, TrendingUp } from "lucide-react";
                ...
                <div className="flex flex-col items-end">
                  <span
                    className={`px-2 py-1 rounded-full text-xs font-medium ${
                      factor.impact === "High Impact" ? "bg-indigo-900/50 text-indigo-300" : "bg-gray-800 text-gray-300"
                    }`}
                  >
                    {factor.impact}
                  </span>
